// utils/StatesAndCities.ts

export class StatesAndCities {
    static readonly statesAndCities: Record<string, string[]> = {
      "All of Sri Lanka": [],
      "Colombo": [
    ...
    static getCities(state: string): string[] {
      return this.statesAndCities[state] ?? [];
    }
  }
